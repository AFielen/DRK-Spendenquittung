...
function mapKreisverband(kv: Record<string, unknown>): Verein {
  return {
    ...
    telefon: (kv.telefon as string) || null,
    email: (kv.email as string) || null,
    bankName: (kv.bankName as string) || null,
    bankIban: (kv.bankIban as string) || null,
    bankBic: (kv.bankBic as string) || null,
