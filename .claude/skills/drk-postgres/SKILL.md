---
name: drk-postgres
description: "PostgreSQL 16 & Prisma ORM Best Practices für DRK-Digitalisierungstools. Verwende diesen Skill bei Variante-B-Apps (Server + Datenbank) für Schema-Design, Migrations, Security (RLS), Query-Optimierung und Docker-Konfiguration."
user-invocable: true
allowed-tools: Read, Grep, Glob, Bash, Edit, Write
argument-hint: "[thema] z.B. schema, prisma, security, rls, migration, docker"
---

# DRK PostgreSQL & Prisma Best Practices

PostgreSQL 16 Best Practices für DRK-Digitalisierungstools.
Stack: Next.js 16 + Prisma ORM + PostgreSQL 16 (Docker) + Hetzner.
...
Die `references/`-Dateien enthalten konkrete SQL- und Prisma-Patterns.
...
| **prisma** | `prisma-schema-patterns.md`, `prisma-migrations.md` | Prisma-ORM-Patterns, Schema, Migrations |
...
- **prisma**, **orm**, **migration** → `prisma-*.md`
